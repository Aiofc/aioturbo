    ...
    return (
        ...
        >
            ...
            {node.children && (
                ...
                <div className="flex items-center cursor-pointer bg-transparent focus:outline-2 focus:outline-blue-500 h-6 w-6"
                     onClick={() =>
                         dispatch({
                             type: "TOGGLE_NODE",
                             id: node.id,
            ...
            <span className="select-none" onClick={() => dispatch({ type: 'NODE_CLICKED', node })} >{node.name}</span>
            </div>
